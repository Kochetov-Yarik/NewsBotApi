namespace NewsBotApi.Models
{
    ...
    public class TopHRootobject
    {
        public string status { get; set; }
        public string request_id { get; set; }
        public TopHDatum[] data { get; set; }
    }

    public class TopHDatum
    {
        ...
        public TopHRelated_Topics[] related_topics { get; set; }
        public Sub_Articles[] sub_articles { get; set; }
        public string story_id { get; set; }
    }

    public class TopHRelated_Topics
    {
